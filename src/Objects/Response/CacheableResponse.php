...
namespace Bytes\HttpClient\Cached\Objects\Response;
...
class CacheableResponse implements ResponseInterface
{
    ...
    public static function createFromResponse(ResponseInterface $response): static
    {
        ...
        return $static->setStatusCode($response->getStatusCode())
